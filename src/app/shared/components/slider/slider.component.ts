  ...
  constructor() { 
    ...
    this.array_slider=[
      {title: "Como mujer rural",
       description: "Puedes ser parte de FemPower seleccionando la opción Únete e indicando el codigo que le asigne su fundación. ",
       requirements: "Requisitos: Pertener a una fundación que se encuentre registrada en FemPower.",
       img: "https://fomenta.org.co/wp-content/uploads/2022/10/ima1-blog.jpg"
      },
      {title: "Como fundación",
       description: "Puedes ser parte de FemPower seleccionando la opción Únete y adjuntando el documento que certifica a la entidad como organizacion sin animo de lucro para mujeres rurales. ",
      ...
      {title: "Como empresa",
       description: "Puedes ser parte de FemPower seleccionando la opción Únete y adjuntando el documento que certifica a la entidad como organizacion legalmente constituida. ",
